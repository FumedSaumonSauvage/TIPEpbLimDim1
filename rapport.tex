...
\end{equation}
en définissant $L_h$ à partir de la fonction $\gamma$ précédente par:  REDÉFINIR LES WH : DANS L'ANALYSE DE LA CONVERGENCE UN PEU PLUS HAUT!!!!!!!!!!!!!!!!!!!!!!
\begin{equation}
...
Nous allons discrétiser la condition de Neumann, en utilisant la \emph{technique du miroir}, qui consiste à ne garder qu'une partie simple d'une fonction $\phi$ et à la développant linéairement:
